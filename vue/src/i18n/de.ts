...
export const de: Partial<IIBI18nMap> = {
  ...
  downloadMeta: 'Metadaten herunterladen',
  pleaseInputMetadataLabel: 'Bitte Label eingeben (max 30 Zeichen)',
  noGeninfo: 'Dieses Bild hat keine Generierungsinformationen',
  generateImageFailed: 'Bildgenerierung fehlgeschlagen',
